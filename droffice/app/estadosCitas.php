...
<?php include("sesion.php");?>
    ...
    $(window).on('resize.jqGrid', function () {+
		...
		$(grid_selector).jqGrid({
			url: "dao_estadosCitas.php",
			datatype: "json",
			mtype: "GET",
			colNames: ["Id", "Estado Citas"],
			colModel: [
				{ name: "id_estado_cita",align:"right"},
				{ name: "descripcion", editable:true}
				],
			pager: pager_selector,
			rowNum: 10,
			rowList: [10,20],
			sortname: "id_estado_cita",
			sortorder: "asc",
      ...
      rownumbers: true,
			...
			viewrecords: true,
			gridview: true,
			editurl: "dao_estadosCitas.php",
			caption:'<span style="font-size:15px">Estados Citas</span>'
		});
