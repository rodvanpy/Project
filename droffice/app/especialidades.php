...
<?php include("sesion.php");?>
    ...
    $(window).on('resize.jqGrid', function () {+
		...
		$(grid_selector).jqGrid({
			url: "dao_especialidades.php",
			datatype: "json",
			mtype: "GET",
			colNames: ["Id", "Especialidades"],
			colModel: [
				{ name: "id_especialidad",align:"right"},
				{ name: "descripcion", editable:true}
			],
			pager: pager_selector,
			rowNum: 10,
			rowList: [10,20],
			sortname: "id_especialidad",
			sortorder: "asc",
      ...
      rownumbers: true,
			...
			viewrecords: true,
			gridview: true,
			editurl: "dao_especialidades.php",
			caption:'<span style="font-size:15px">Especialidades</span>'
		});
